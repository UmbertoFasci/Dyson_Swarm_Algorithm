...
ax.set_ylabel('Y')
ax.set_zlabel('Z')
agents_scatter = ax.scatter(agents[:, 0], agents[:, 1], agents[:, 2], c='g', s=50)
points_surface = ax.plot_surface(x, y, z, facecolors=plt.colormaps.get_cmap('Reds')(data), alpha=0.5)
...
#+RESULTS:
[[file:./.ob-jupyter/bd322271994cb62aa9f8cb18e6dc88411babbfa0.png]]
